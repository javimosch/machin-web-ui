# MAINTAINING — how to work on machin-web-ui itself

For an agent **extending or fixing the framework** (not building an app with
it — that's [AGENTS.md](../AGENTS.md)). Read [VISION.md](VISION.md) for the
north star; this is the operational playbook.
